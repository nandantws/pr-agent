...
class PRReviewer:
    ...
    """
    def __init__(self, pr_url: str, is_answer: bool = False, is_auto: bool = False, args: list = None, oauth_token=None):
        """
        ...
        self.git_provider = get_git_provider()(pr_url, oauth_token, incremental=self.incremental)
